...
//Este programa é para desenhar um triangulo utilizando apenas asteriscos
...
//Processamento obs: Para cada dimensão do triangulo você precisa de um novo laço de repetição
	for (int i = 0; i < tamanhoTriangulo; i++) { //i é linhas e j é colunas
		for (int j = 0; j <= i; j++) { //A quantidade de colunas que serão impressas depende do numero da linha
			System.out.print("*");
		}
		System.out.println();
		}
